...
.impact-card{display:grid;grid-template-columns:300px 1fr;gap:1.2rem;border:1px solid var(--global-divider-color);border-radius:16px;overflow:hidden;background:var(--global-bg-color)}
.impact-media{width:100%;height:100%;min-height:220px;overflow:hidden}
.impact-media img{width:100%;height:100%;object-fit:cover}
.impact-body{padding:1rem 1rem 1rem 0;display:flex;flex-direction:column;justify-content:center}
.impact-year{color:var(--global-theme-color);font-weight:700;margin-bottom:.3rem}
.impact-title{font-weight:700;font-size:1.05rem;margin-bottom:.5rem}
...
<div class="impact-card">
<div class="impact-media">
<blockquote class="twitter-tweet"><a href="https://x.com/anadoluajansi/status/1641817643434008579"></a></blockquote>
</div>
<div class="impact-body">
<div class="impact-year">2023</div>
<div class="impact-title">
